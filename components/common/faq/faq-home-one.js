					...
					<div className="col-lg-5 position-relative">
						<div className="BL-default-content large-content">
							...
							<Link href={"/contact"} legacyBehavior>
								<a className="BL-faq-btn">Don't find the answer? Contact us here</a>
							</Link>
						</div>
					</div>

					<div className="col-lg-5 offset-lg-2">
						<div className="BL-accordion-wrap">
							...
							<div className="BL-accordion-item">
								<h4>How do I connect BL to my crypto wallet?</h4>
								<p>
									Once you ve approved a connection request from the app the BL can send transaction
