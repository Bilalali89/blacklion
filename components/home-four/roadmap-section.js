...
export default function RoadmapSection() {
	return (
		<div className="BL--roadmap-section BL--roadmap-v2">
			<div className="container">
				...
				<div className="row">
					...
					<div className="col-xl-3 col-md-6">
						<div className="BL--iconbox-wrap wow fadeInUpX" data-wow-delay="0.10s">
							<div className="BL--iconbox-thumb">
					...
					<div className="col-xl-3 col-md-6">
						<div className="BL--iconbox-wrap wow fadeInUpX" data-wow-delay="0.20s">
							<div className="BL--iconbox-thumb">
					...
					<div className="col-xl-3 col-md-6">
						<div className="BL--iconbox-wrap wow fadeInUpX" data-wow-delay="0.30s">
							<div className="BL--iconbox-thumb">
