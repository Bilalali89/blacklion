...
export default function FeatureSection() {
	return (
		<div className="BL--feature2-section BL--section-padding2">
			<div className="container">
				...
				<div className="row">
					<div className="col-xl-4 col-md-6">
						<div className="BL--feature-wrap wow fadeInUpX" data-wow-delay=".10s">
							<div className="BL--feature-data">
								<h2>01</h2>
					...
					<div className="col-xl-4 col-md-6">
						<div className="BL--feature-wrap wow fadeInUpX" data-wow-delay=".20s">
							<div className="BL--feature-data">
								<h2>02</h2>
					...
					<div className="col-xl-4 col-md-6">
						<div className="BL--feature-wrap wow fadeInUpX" data-wow-delay=".30s">
							<div className="BL--feature-data">
								<h2>03</h2>
