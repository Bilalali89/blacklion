			...
			<div className="container">
				...
				<div className="row">
					<div className="col-lg-6">
						<div className="BL-iconbox-wrap BL-iconbox-wrap5 wow fadeInUpX" data-wow-delay="0s">
							<div className="BL-iconbox-icon">
					...
					<div className="col-lg-6">
						<div className="BL-iconbox-wrap BL-iconbox-wrap5 wow fadeInUpX" data-wow-delay=".10s">
							<div className="BL-iconbox-icon">
					...
					<div className="col-lg-6">
						<div className="BL-iconbox-wrap BL-iconbox-wrap5 wow fadeInUpX" data-wow-delay=".20s">
							<div className="BL-iconbox-icon">
					...
					<div className="col-lg-6">
						<div className="BL-iconbox-wrap BL-iconbox-wrap5 wow fadeInUpX" data-wow-delay=".30s">
							<div className="BL-iconbox-icon">
					...
					<div className="col-lg-6">
						<div className="BL-iconbox-wrap BL-iconbox-wrap5 wow fadeInUpX" data-wow-delay=".40s">
							<div className="BL-iconbox-icon">
					...
					<div className="col-lg-6">
						<div className="BL-iconbox-wrap BL-iconbox-wrap5 wow fadeInUpX" data-wow-delay=".50s">
							<div className="BL-iconbox-icon">
