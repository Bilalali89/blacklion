...
export default function TradingSection() {
	return (
		<div className="section bg-warning-100 BL-section-padding overflow-hidden">
			<div className="container">
				<div className="row">
					<div className="col-lg-6">
						<div className="BL-trading-card">
					...
					<div className="col-lg-6 col-md-10 d-flex align-items-center">
						<div className="BL-default-content z-index">
							...
							<div className="BL-icon-list BL-icon-list3">
								<ul>
									<li>
